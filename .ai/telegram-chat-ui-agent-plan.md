...
- [ ] **F1**: Новый layout Composer: скрепка слева, авто‑textarea по центру, самолётик справа.
- [ ] **F2**: Авто‑рост textarea до 5 строк, дальше внутренний скролл; Enter отправка, Shift+Enter новая строка.
- [ ] **F3**: Панель предпросмотра изображения (40×40, имя, размер, крестик) над строкой ввода.
- [ ] **F4**: Pending‑состояние: блокировать всё, не допускать повторной отправки.
- [ ] **F5**: Режим редактирования (UI/горячие клавиши/валидация/кнопки “Отмена/Сохранить”).
